...
import numpy as np
import copy
from conifer.utils import _ap_include, _gcc_opts, copydocstring
...
class XilinxHLSModel(ModelBase):
    ...
    def compile(self):
        ...
        cmd = f"g++ -O3 -shared -std=c++14 -fPIC $(python -m pybind11 --includes) {ap_include} {_gcc_opts()} bridge.cpp firmware/BDT.cpp firmware/{cfg.project_name}.cpp -o conifer_bridge_{self._stamp}.so"

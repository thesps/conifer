...
splitting_conventions = {
  ...
  "onnx": "<=",    #the splitting convention for onnx models is user customizable. https://github.com/onnx/onnx/blob/a6b828cdabfb5c0f8795d82e6a3851224acecd10/onnx/defs/traditionalml/defs.cc#L1051-L1057
